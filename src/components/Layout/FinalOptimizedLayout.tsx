...
export function FinalOptimizedLayout() {
  ...
  useEffect(() => {
    ...
    if (isAdminMode) {
      root.style.setProperty("--sidebar-background", "rgb(15 23 42)");
      root.style.setProperty("--sidebar-foreground", "rgb(241 245 249)");
      root.style.setProperty("--sidebar-border", "rgb(51 65 85)");
    } else {
      root.style.setProperty("--sidebar-background", "hsl(var(--sidebar))");
      root.style.setProperty(
        "--sidebar-foreground",
        "hsl(var(--sidebar-foreground))",
      );
      root.style.setProperty("--sidebar-border", "hsl(var(--sidebar-border))");
    }
  ...
  return (
    ...
    >
      ...
      {/* Chat Widget - positioned to avoid footer on mobile */}
      <ConversacaoWidget
        className={cn(
