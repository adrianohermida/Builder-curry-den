/**
 * 🏛️ MODERN SIDEBAR - LAWDESK REFACTORED
 *
 * Sidebar modernizada inspirada em Notion/Linear/HubSpot:
 * - Seções colapsáveis: Workspace Jurídico, Operações, Administração
 * - Ícones minimalistas customizados para setor jurídico
 * - Hover para mostrar nomes (UI mais limpa)
