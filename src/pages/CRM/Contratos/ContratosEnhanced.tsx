...
export default function ContratosEnhanced() {
  ...
  // Mock data - Enhanced with AI insights
    ...
    () => [
      {
        ...
        aiInsights: {
          riskScore: 15,
          recommendations: [
            "Contrato bem estruturado com baixo risco",
            "Pagamentos em dia nos últimos 6 meses",
            "Recomenda-se renovação automática",
          ],
      ...
      },
      {
        ...
        aiInsights: {
          riskScore: 8,
          recommendations: [
            "Cliente Premium com excelente histórico",
            "Possibilidade de upsell para plano corporativo",
            "Renovação garantida para próximo período",
          ],
          lastAnalysis: "2024-01-20T15:30:00Z",
        },
      ...
      },
      {
        ...
        aiInsights: {
          riskScore: 45,
          recommendations: [
            "Contrato aguardando assinatura há 5 dias",
            "Recomenda-se follow-up com cliente",
            "Revisar cláusulas de taxa de sucesso",
          ],
          lastAnalysis: "2024-01-22T09:15:00Z",
        },
...
...`,
    ...
    filteredContracts.forEach((contract) => {
      ...
      groupedData[groupKey].push({
        ...
        metadata: {
          ...
          riskScore: contract.aiInsights?.riskScore || 0,
        },
      });
    });
  ...
  const stats = useMemo(() => {
    ...
    const avgRiskScore =
      contracts.reduce((sum, c) => sum + (c.aiInsights?.riskScore || 0), 0) /
      contracts.length;
  ...
  const handleStripeConfig = useCallback((contract: Contract) => {
    setSelectedContractForAction(contract);
  ...
  const handleAIAnalysis = useCallback(async () => {
    ...
    try {
      ...
      toast.success("Análise de IA concluída! Insights atualizados.");
    } catch (error) {
  ...
  const handleSignatureStatusChange = useCallback(
    (contractId: string, newStatus: string) => {
                ...
                <TableCell>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem
                        onClick={() => handleStripeConfig(contract)}
                      >
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      >
        <div>
          <h1 className="text-3xl font-bold">Gestão de Contratos Enhanced</h1>
          <p className="text-muted-foreground">
            Contratos inteligentes com IA, assinaturas digitais e Stripe
            integrado
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <Card className="border-0 shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Risk Score IA</CardTitle>
      ...
      {selectedContractForAction && (
        <AssinaturaDigital
          contrato={{
            id: selectedContractForAction.id,
            titulo: selectedContractForAction.title,
            cliente: {
              id: selectedContractForAction.client.id,
              nome: selectedContractForAction.client.name,
              email: selectedContractForAction.client.email,
              telefone: selectedContractForAction.client.phone,
              tipo: selectedContractForAction.client.type,
              documento: "123.456.789-00",
            },
            advogado: {
              id: selectedContractForAction.lawyer.id,
              nome: selectedContractForAction.lawyer.name,
            ...
            assinaturas: {
              cliente: {
                assinado: selectedContractForAction.signatures.client,
              },
              advogado: {
                assinado: selectedContractForAction.signatures.lawyer,
              },
            },
            documentos: {
              original: "contrato_original.pdf",
            },
            configuracoes: {
              ...
              historicoEventos: [
                {
                  ...
                  detalhes: "Contrato criado no sistema",
                },
              ],
            },
          }}
      ...
      {selectedContractForAction && (
        <StripeIntegration
          ...
          initialConfig={selectedContractForAction.stripeConfig}
        />
      )}
    </div>
  );
