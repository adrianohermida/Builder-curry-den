  ...
  const metricas = [
    {
      ...
      valor: estatisticas.clientes.total.toLocaleString(),
      change: "+12%",
      icone: Users,
      cor: "text-blue-600",
      bgCor: "bg-blue-100",
      meta: 150,
      atual: estatisticas.clientes.total,
    },
    {
      titulo: "Processos Ativos",
      valor: estatisticas.processos.ativos.toLocaleString(),
      change: "+8%",
      icone: Scale,
      cor: "text-green-600",
      bgCor: "bg-green-100",
      meta: 50,
      atual: estatisticas.processos.ativos,
    },
    {
      titulo: "Contratos Vigentes",
      valor: estatisticas.contratos.vigentes.toLocaleString(),
      change: "+15%",
      icone: FileSignature,
      cor: "text-purple-600",
      bgCor: "bg-purple-100",
      meta: 25,
      atual: estatisticas.contratos.vigentes,
    },
    {
      titulo: "Receita Mensal",
      valor: `R$ ${estatisticas.contratos.valor_total.toLocaleString()}`,
      change: "+22%",
      icone: DollarSign,
      cor: "text-emerald-600",
      bgCor: "bg-emerald-100",
      meta: 400000,
      atual: estatisticas.contratos.valor_total,
    },
  ];
  ...
  const modulosRapidos = [
    {
      ...
      total: estatisticas.clientes.total,
    ...
    },
    {
      ...
      total: estatisticas.processos.ativos,
    ...
    },
    {
      ...
      total: estatisticas.contratos.vigentes,
